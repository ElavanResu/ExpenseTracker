...
export default class RNPickerSelect extends PureComponent {
  ...
  static defaultProps = {
    ...
    style: {},
    children: null,
    placeholderTextColor: 'transparent', // deprecated
  ...
  renderTextInputOrChildren () {
    ...
    const containerStyle =
        Platform.OS === 'ios' ? style.inputIOSContainer : defaultStyles.inputAndroidContainer
    ...
    return (
      <View pointerEvents='box-only' style={containerStyle}>
        <TextInput
          style={[
            Platform.OS === 'ios' ? style.inputIOS : defaultStyles.inputAndroid,
